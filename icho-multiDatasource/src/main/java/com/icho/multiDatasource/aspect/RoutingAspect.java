package com.icho.multiDatasource.aspect;
...
import com.icho.multiDatasource.exception.ParamsNotContainsRoutingField;
...
public class RoutingAspect {
    ...
    @Pointcut("@annotation(com.icho.multiDatasource.annotation.Router)")
